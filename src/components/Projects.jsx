          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start border-b border-black/5 pb-6 group-hover:border-black/20 transition-colors">
                <div>
                  <h3 className="text-2xl md:text-3xl font-light tracking-tight mb-2 group-hover:translate-x-1 transition-transform duration-300">{project.name}</h3>
                  <p className="text-gray-400 font-light text-sm uppercase tracking-widest">{project.location}</p>
                </div>
