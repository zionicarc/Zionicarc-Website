...
export default function WhyChooseUs() {
    ...
    const reasons = [
        {
            title: "Experience",
            desc: "With over 10 years of experience in the industry, Z'IONIC ARC has a proven track record of delivering high-quality, innovative designs.",
            icon: <Award size={28} strokeWidth={1.5} />
        },
        {
            title: "Expert Team",
            desc: "Our team of skilled architects, designers, and project managers are passionate about creating spaces that inspire and impress.",
            icon: <Users size={28} strokeWidth={1.5} />
        },
        {
            title: "Customized Solutions",
            desc: "Every project is unique. Our customized design solutions are tailored to meet the specific needs and preferences of each client.",
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-8">
                ...
                <div className="mb-20 max-w-2xl">
                    ...
                    <p className="mt-6 text-lg text-gray-700 font-normal">
                        A decade of architectural excellence shaped by experience,
                        collaboration, and clarity of vision.
                    </p>
                </div>
